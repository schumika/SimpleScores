...
+ (UIColor *)AJPinkColor {
    return [UIColor colorWithHexString:@"ef6374"];
}

+ (UIColor *)AJPurpleColor {
    return [UIColor colorWithHexString:@"6541b0"];
}
...
+ (UIColor *)AJVioletColor {
    return [UIColor colorWithHexString:@"be46e0"];
}

+ (UIColor *)AJBrightOrangeColor {
    return [UIColor colorWithHexString:@"f84f19"];
}
